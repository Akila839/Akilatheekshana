...
document.getElementById("b2").onclick=function(){
    ...
    document.getElementById("div1").style.backgroundColor="rgb(31, 30, 30)";
    document.getElementById("h21").style.color="white"
    document.getElementById("pa1").style.color="white"
    document.getElementById("h32").style.color="white"
    document.getElementById("pa2").style.color="white"
    document.getElementById("h33").style.color="white"
    document.getElementById("con1").style.color="white"
    document.getElementById("pa3").style.color="white"
    document.getElementById("pa4").style.color="white"
    document.getElementById("h34").style.color="white"
    document.getElementById("h41").style.color="white"
    document.getElementById("div2").style.backgroundColor="rgb(31, 30, 30)"
    document.body.style.backgroundColor="rgb(13, 14, 13)"
    document.getElementById("h41").style.color="white"
